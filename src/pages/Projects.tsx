...
const initialTasks: Task[] = [
  {
    ...
    priority: 'medium',
    dueDate: 'Lun 15',
    assignees: [{ name: 'Aminata', avatar: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=100' }],
    comments: 3,
  ...
  },
  {
    ...
    priority: 'urgent',
    dueDate: "Aujourd'hui",
    assignees: [{ name: 'Kwame', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100' }],
    comments: 8,
  ...
  },
  {
    ...
    priority: 'medium',
    assignees: [{ name: 'Ousmane', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100' }],
    comments: 2,
    columnId: 'done',
  },
];
